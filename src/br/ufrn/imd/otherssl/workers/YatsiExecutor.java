...
public class YatsiExecutor {
	...
	public static String version = "YATSI";
	...
	public static void run(Dataset dataset, String llgcVersion) throws Exception {
		...
		llgcOw = new OutputWriter(llgcOwBasePath + llgcVersion + "_" + dataset.getDatasetName());
		...
		eval.crossValidateModel(yatsi, dataset.getInstances(), 10, new Random(157));
